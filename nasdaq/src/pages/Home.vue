...
export default {
  ...
  computed: {
    ...
    ...mapState({
      reqIndexCateModule: state => state.home2.reqIndexCateModule,
      reqIndex: state => state.home2.reqIndex.policyDescList,
      reqIndexkingKongModule: state =>
        state.home2.reqIndex.kingKongModule.kingKongList
    })
  },
  mounted () {
